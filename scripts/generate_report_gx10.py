...
<head>
    ...
    <title>Qwen2.5 GGUF Benchmark Report — NVIDIA GB10</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>llama.cpp Inference Performance on NVIDIA CUDA</p>
            <div class="gpu-badge">{GPU_NAME} &bull; Blackwell (GB10) &bull; {RAM_TOTAL} Unified Memory &bull; CUDA {CUDA_VER}</div>
        </div>
        ...
        <div class="footer">
            ...
            <p>{GPU_NAME} &bull; Blackwell (GB10) &bull; {RAM_TOTAL} Unified Memory &bull; CUDA {CUDA_VER} &bull; llama.cpp (CUDA)</p>
        </div>
    </div>
    ...
    <script>
        ...
        var specsCols = [
            [
                ...
                ['Memory', '{RAM_TOTAL} Unified (CPU+GPU)'],
